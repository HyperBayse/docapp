<link rel="stylesheet" href="/docapp/ext/search.css">
<script type="module" src="/docapp/ext/search.js" defer></script>

<!-- Search Section -->
<span class="property_search">
    <input onfocus="this.style.outline = 'none'" type="text" placeholder="search for properties">
    <img class="search_icon" src="/docapp/stf/img/searchIcon.svg" alt="search icon">
    

    <div class="sr_instance">
        <section id="filter">
            <img class="filter_icon" src="/docapp/stf/img/filter.svg" alt="fi">
            <img class="cancelIcon" src="/docapp/stf/img/cancelIcon.svg" alt="cancel icon">
